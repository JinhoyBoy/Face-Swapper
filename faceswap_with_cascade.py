...
gray1 = manual_grayscale(image1)
gray2 = manual_grayscale(image2)
...
if len(faces1) < 1 or len(faces2) < 1:
    ...
    # Display the images
    plt.figure(figsize=(10, 6), num="Face Swapping with Cascade Classifier")
    ...
    plt.subplot(1, 3, 3)
    plt.imshow(result2[:, :, ::-1]) # Convert BGR to RGB
